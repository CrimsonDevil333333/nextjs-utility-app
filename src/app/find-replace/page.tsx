...
export default function FindReplacePage() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-8">
      <h1 className="text-3xl font-bold mb-6 text-gray-900 dark:text-gray-100">Find & Replace Text</h1>
      ...
      <div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
        ...
        <div className="flex flex-wrap gap-4 mb-6">
          ...
          <label className="flex items-center text-gray-700 dark:text-gray-300">
            <input
              ...
              onChange={(e) => { setMatchWholeWord(e.target.checked); if (e.target.checked) setUseRegex(false); }}
              disabled={useRegex}
              className="mr-2 h-4 w-4 text-blue-600 rounded focus:ring-blue-500 border-gray-300 dark:border-gray-600 dark:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed"
            />
            Match Whole Word
          </label>
          <label className="flex items-center text-gray-700 dark:text-gray-300">
            <input
              type="checkbox"
              checked={useRegex}
              onChange={(e) => { setUseRegex(e.target.checked); if (e.target.checked) setMatchWholeWord(false); }}
              className="mr-2 h-4 w-4 text-blue-600 rounded focus:ring-blue-500 border-gray-300 dark:border-gray-600 dark:bg-gray-700"
            />
        ...
        {error && (
          <p className="mt-2 text-sm text-red-600 dark:text-red-400 mb-4">{error}</p>
        )}
        ...
        <div className="relative mb-6">
          ...
          <div className="relative">
            <textarea
              ...
              readOnly
              rows={8}
              className="w-full p-2.5 font-sans text-base border rounded-lg resize-y bg-gray-100 dark:bg-gray-900 dark:border-gray-700 text-gray-800 dark:text-gray-200 cursor-default select-all pr-12"
