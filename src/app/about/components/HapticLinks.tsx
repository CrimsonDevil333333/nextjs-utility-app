...
export function HapticLinks({ type }: { type: 'social' | 'feedback' | 'contribute' }) {
  if (type === 'social') {
    return (
  ...
  if (type === 'feedback') {
    return (
      <Link href="https://github.com/CrimsonDevil333333/nextjs-utility-app/issues" target="_blank" rel="noopener noreferrer" onClick={triggerHapticFeedback} className="inline-flex items-center px-6 py-3 bg-green-600 text-white font-semibold rounded-lg shadow hover:bg-green-700 transition-colors">
  ...
  if (type === 'contribute') {
    return (
      <Link href="https://github.com/CrimsonDevil333333/nextjs-utility-app" target="_blank" rel="noopener noreferrer" onClick={triggerHapticFeedback} className="inline-flex items-center px-6 py-3 bg-purple-600 text-white font-semibold rounded-lg shadow hover:bg-purple-700 transition-colors">
