...
export const metadata: Metadata = {
  ...
  description: 'Learn more about the Dev Toolkit project and its creator, Satyaa G.',
};
  ...
  return (
    <main className="min-h-screen p-4 sm:p-8 bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-950">
      <div className="max-w-4xl mx-auto py-8">
        <h1 className="text-4xl sm:text-5xl font-extrabold text-center mb-6 text-gray-900 dark:text-gray-100">
        ...
        <section className="mb-10 p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            The Dev Toolkit is a passion project aimed at providing a comprehensive, easy-to-use, and highly accessible collection of online utilities. Whether you're a developer, designer, student, or just someone who needs a quick tool for a daily task, our goal is to streamline your workflow and make complex operations simple.
          </p>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            From data converters and text manipulators to specialized developer tools, we're constantly working to expand our offerings and ensure a smooth user experience.
          </p>
        </section>
        ...
        <section className="mb-10 p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            {/* Add any other significant libraries like react-markdown, react-syntax-highlighter etc. */}
            ...
            <span className="px-4 py-2 bg-red-100 text-red-800 rounded-full dark:bg-red-900 dark:text-red-200 text-sm font-medium">Syntax Highlighting</span>
          </div>
        </section>
        ...
        <section className="mb-10 p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
          ...
          <div className="flex gap-4 justify-center sm:justify-start">
            <Link
              href="https://github.com/CrimsonDevil333333"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center px-4 py-2 bg-gray-900 text-white rounded-lg shadow hover:bg-gray-700 transition-colors dark:bg-gray-100 dark:text-gray-900 dark:hover:bg-gray-300"
            >
            ...
            <Link
              href="https://www.linkedin.com/in/satyaa-g-b4b399111/"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center px-4 py-2 bg-blue-700 text-white rounded-lg shadow hover:bg-blue-600 transition-colors"
            >
        ...
        <section className="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
          ...
          <div className="text-center">
             <Link
                href="https://github.com/CrimsonDevil333333/nextjs-utility-app/issues" // Assuming your repo is 'nextjs-utility-app'
                target="_blank"
                rel="noopener noreferrer"
