...
export const utilities: Utility[] = [
  ...
  // { name: 'Image Generator', href: '/image-generator', description: 'Create unique images from a text description using AI.', emoji: '🖼️', category: 'AI Tools' },
  ...
  { name: 'Regex Generator', href: '/regex-generator', description: 'Generate regular expressions from a text description using AI.', emoji: '✍️', category: 'AI Tools' },
  ...
  { name: 'SQL Query Generator', href: '/sql-query-generator', description: 'Generate SQL queries from a text description using AI.', emoji: '🗃️', category: 'AI Tools' },
