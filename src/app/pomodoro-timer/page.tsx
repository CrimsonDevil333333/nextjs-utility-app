...
const PomodoroTimerPage = () => {
  ...
  return (
    <div className={`min-h-[calc(100dvh-4rem)] w-full flex flex-col items-center justify-center bg-gray-50 dark:bg-gray-900 p-4 transition-colors duration-500 ${mode === 'pomodoro' ? 'bg-red-100 dark:bg-red-900/50' :
