      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-4">
            ...
            <input id="textColor" type="color" value={textColor} onChange={e => { setTextColor(e.target.value); triggerHapticFeedback(); }} className="w-16 h-12 p-1 border-none rounded-lg cursor-pointer" />
            <input type="text" value={textColor} onChange={e => setTextColor(e.target.value)} onFocus={triggerHapticFeedback} className="p-2 w-full border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800" />
          </div>
          <div className="flex items-center gap-4">
            <label htmlFor="bgColor" className="font-semibold text-lg w-32">Background</label>
            <input id="bgColor" type="color" value={bgColor} onChange={e => { setBgColor(e.target.value); triggerHapticFeedback(); }} className="w-16 h-12 p-1 border-none rounded-lg cursor-pointer" />
            <input type="text" value={bgColor} onChange={e => setBgColor(e.target.value)} onFocus={triggerHapticFeedback} className="p-2 w-full border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800" />
          </div>
        </div>
